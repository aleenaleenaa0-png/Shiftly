...
const WorkerHeader: React.FC<WorkerHeaderProps> = ({ userName, activeTab, setActiveTab, onLogout }) => {
  return (
        ...
        <div className="flex justify-between items-center h-20">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="hidden md:flex items-center gap-3">
              ...
              <button 
                onClick={onLogout}
                className="p-2 bg-red-500 text-white rounded-xl shadow-lg shadow-red-100 hover:bg-red-600 transition-colors"
                title="Logout"
              >
